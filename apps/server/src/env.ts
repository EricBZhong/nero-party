...
export const env = {
  ...
  SPOTIFY_SCOPES:
    process.env.SPOTIFY_SCOPES ?? "streaming user-read-email user-read-private user-modify-playback-state user-read-playback-state user-read-currently-playing",
